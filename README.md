...
<img align="right" width="38%" src="https://media.giphy.com/media/ar71Hyi0ZKejXzMoNs/giphy.gif" />
...
| [cowpro-ssl-extensions](https://github.com/suyashkumar234/cowpro-ssl-extensions) | Few-shot medical image segmentation |
| [eeg-labram](https://github.com/suyashkumar234/eeg-labram) | LaBraM foundation model · EEG |
...
{ "dl":    ["PyTorch", "TensorFlow", "MONAI"],
  "cv":    ["OpenCV", "scikit-learn", "MNE-Python"],
  "tools": ["Git", "Docker", "SLURM", "FastAPI"],
